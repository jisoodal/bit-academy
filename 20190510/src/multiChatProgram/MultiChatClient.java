...
public class MultiChatClient implements ActionListener, Runnable{
	...
	public MultiChatClient(String ip) {
		...
		listInput = new JTextField(10);
		listPanel.add(listInput, BorderLayout.EAST);
	...
	public void connectServer() {
		try {
			...
			// e.printStackTrace();
			System.out.println("[MultiChatClient]connectServer()Exp 발생!");
		}
	}
	...
	public static void main(String[] args) {
		MultiChatClient mcc = new MultiChatClient("192.168.0.64");
	}
}
