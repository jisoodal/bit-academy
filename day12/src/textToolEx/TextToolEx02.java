...
public class TextToolEx02 extends Frame implements WindowListener 
{ 
      TextArea ta; 
      ...
      private void registerEventHandler() { 
            ...
            btn[0].addActionListener(new ActionListener() { // Undo - 작업이전 상태로 되돌림 
                  public void actionPerformed(ActionEvent ae) { 
                	...
                	if(!prevText.equals(""))
                		ta.setText(prevText); // setText = textView에 텍스트를 놓는 것
                	
                	prevText = curText; // 버퍼에 담은게 아니기 때문에 가장 마지막 내역을 기억
      ...
      public static void main(String[] args) { 
            TextToolEx02 win = new TextToolEx02("Text Tool"); 
            win.show(); 
      } 
