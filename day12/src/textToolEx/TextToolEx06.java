...
public class TextToolEx06 extends Frame implements WindowListener 
{ 
      TextArea ta; 
      ...
      String[] btnName = { 
            ...
            "Erase Words contain Param1",    // Param1에 지정된 문자들을 삭제하는 기능 
            "Trim",           // 라인의 앞뒤 공백을 제거 
            "Erase Null Line(s)",   // 빈 줄 삭제 
            "Add Param1 f Param2 b",  // Param1과 Param2의 문자열을 각 라인의 앞뒤에 붙이는 기능 
...
//                        	param1의 문자열길이와 param2의 문자열 길이를 이용)
                        	...
                        	String a = line.substring(p1.length(), line.length()-p2.length());
                        	
                        	sb.append(a).append(CR_LF);
                        }
 //                      4. 작업이 끝난 후에 sb에 담긴 내용을 ta에 보여준다.(setText()사용)
                        System.out.println(p1.length());
                        System.out.println(curText.length()-p2.length());
                        System.out.println(curText.length());
                        ta.setText(sb.toString());
                        
                        for(int i=0;i<curText.length();i++) {
                        	System.out.printf("%d:%d%n", i, (int)curText.charAt(i));
                        }
                  } 
            }); 
      ...
      public static void main(String[] args) { 
            TextToolEx06 win = new TextToolEx06("Text Tool"); 
            win.show(); 
      } 
