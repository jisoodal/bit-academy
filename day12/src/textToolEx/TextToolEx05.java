...
public class TextToolEx05 extends Frame implements WindowListener 
{ 
      TextArea ta; 
...
//                    3. 읽어온 라인의 앞뒤에 param1과 param2의 값을 붙여서 sb에 담는다.
                        	sb.append(p1).append(line).append(p2).append(CR_LF);
                        }
    //                   4. 작업이 끝난 후에 sb에 담긴 내용을 ta에 보여준다.(setText()사용)
      ...
      public static void main(String[] args) { 
            TextToolEx05 win = new TextToolEx05("Text Tool"); 
            win.show(); 
      } 
